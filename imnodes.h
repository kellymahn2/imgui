...
enum ImNodesCol_
{
    ...
    ImNodesCol_LinkStart, // Added to support different colors at ends
    ImNodesCol_LinkEnd,  // Added to support different colors at ends
    ImNodesCol_LinkHoveredStart,  // Added to support different colors at ends
    ImNodesCol_LinkHoveredEnd,  // Added to support different colors at ends
    ImNodesCol_LinkSelectedStart,  // Added to support different colors at ends
    ImNodesCol_LinkSelectedEnd,  // Added to support different colors at ends
    ImNodesCol_Pin,
...
bool IsLinkDropped(int* started_at_attribute_id = NULL, int* started_at_node_id = NULL, bool including_detached_links = true);
