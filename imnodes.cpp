...
void ClickInteractionUpdate(ImNodesEditorContext& editor)
{
    ...
    case ImNodesClickInteractionType_LinkCreation:
    {
        ...
        GImNodes->CanvasDrawList->AddBezierCubic(
            ...
            cubic_bezier.P2,
            cubic_bezier.P3,
            GImNodes->Style.Colors[ImNodesCol_LinkStart],
...
void DrawLink(ImNodesEditorContext& editor, const int link_idx)
{
    ...
    ImU64 link_color = link.ColorStyle.Base;
...
void StyleColorsDark(ImNodesStyle* dest)
{
    ...
    dest->Colors[ImNodesCol_LinkStart] = dest->Colors[ImNodesCol_LinkEnd] = IM_COL32(61, 133, 224, 200);
    dest->Colors[ImNodesCol_LinkHoveredStart] = dest->Colors[ImNodesCol_LinkHoveredEnd] = IM_COL32(61, 133, 224, 200);
    dest->Colors[ImNodesCol_LinkSelectedStart] = dest->Colors[ImNodesCol_LinkSelectedEnd] = IM_COL32(61, 133, 224, 200);
    ...
    dest->Colors[ImNodesCol_MiniMapLink] = dest->Colors[ImNodesCol_LinkStart];
    dest->Colors[ImNodesCol_MiniMapLinkSelected] = dest->Colors[ImNodesCol_LinkSelectedStart];
...
void StyleColorsClassic(ImNodesStyle* dest)
{
    ...
    dest->Colors[ImNodesCol_LinkStart] = dest->Colors[ImNodesCol_LinkEnd] = IM_COL32(255, 255, 255, 100);
    dest->Colors[ImNodesCol_LinkHoveredStart] = dest->Colors[ImNodesCol_LinkHoveredEnd] = IM_COL32(105, 99, 204, 153);
    dest->Colors[ImNodesCol_LinkSelectedStart] = dest->Colors[ImNodesCol_LinkSelectedEnd] = IM_COL32(105, 99, 204, 153);
...
void StyleColorsLight(ImNodesStyle* dest)
{
    ...
    dest->Colors[ImNodesCol_LinkStart] = dest->Colors[ImNodesCol_LinkEnd] = IM_COL32(66, 150, 250, 100);
    // original imgui values: 117, 138, 204
    dest->Colors[ImNodesCol_LinkHoveredStart] = dest->Colors[ImNodesCol_LinkHoveredEnd] = IM_COL32(66, 150, 250, 242);
    dest->Colors[ImNodesCol_LinkSelectedStart] = dest->Colors[ImNodesCol_LinkSelectedEnd] = IM_COL32(66, 150, 250, 242);
    // original imgui values: 66, 150, 250
...
void Link(const int id, const int start_attr_id, const int end_attr_id)
{
    ...
    link.ColorStyle.Base = ((uint64_t)GImNodes->Style.Colors[ImNodesCol_LinkStart] << 32) + (uint64_t)GImNodes->Style.Colors[ImNodesCol_LinkEnd];
    link.ColorStyle.Hovered = ((uint64_t)GImNodes->Style.Colors[ImNodesCol_LinkHoveredStart] << 32) + (uint64_t)GImNodes->Style.Colors[ImNodesCol_LinkHoveredEnd];
    link.ColorStyle.Selected = ((uint64_t)GImNodes->Style.Colors[ImNodesCol_LinkSelectedStart] << 32) + (uint64_t)GImNodes->Style.Colors[ImNodesCol_LinkSelectedEnd];
...
bool IsLinkDropped(int* const started_at_id, int* started_at_node_id, const bool including_detached_links)
{
    // Call this function after EndNodeEditor()!
    IM_ASSERT(GImNodes->CurrentScope == ImNodesScope_None);
    ...
    if (link_dropped)
    {
        ...
        if (started_at_node_id)
        {
            *started_at_node_id = editor.Nodes.Pool[editor.Pins.Pool[pin_idx].ParentNodeIdx].Id;
        }
    }
